...
//		this.selectButton(NewRectangleShapeButton);
		dialogProcessor.AddNewRandomRectangle();
//		statusMessageLabel.setText("Последно действие: Рисуване на правоъгълник");
		dialogProcessor.repaint();
	}
...
//		dialogProcessor.repaint();
	...
	@Action
	public void save() {
		dialogProcessor.serializeObject();
	}
	
	@Action
	public void openFile() {
		dialogProcessor.deserializeObject();
		dialogProcessor.repaint();
	}
	...
	private void initComponents() {
		...
		DrawCicleShapeButton = new javax.swing.JButton();
		...
		NewRectangleShapeButton = new JButton();
		...
		NewRectangleShapeButton.setAction(actionMap.get("drawNewRectangle")); // NOI18N
		NewRectangleShapeButton.setIcon(resourceMap.getIcon("NewRectangleShapeButton.icon")); // NOI18N
		NewRectangleShapeButton.setText(resourceMap.getString("NewRectangleShapeButton.text")); // NOI18N
		NewRectangleShapeButton.setFocusable(false);
		NewRectangleShapeButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		NewRectangleShapeButton.setName("NewRectangleShapeButton"); // NOI18N
		NewRectangleShapeButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		toolBar.add(NewRectangleShapeButton);
		
		DrawCicleShapeButton.setAction(actionMap.get("drawNewEllipse")); // NOI18N
		DrawCicleShapeButton.setIcon(resourceMap.getIcon("DrawCircleShapeButton.icon")); // NOI18N
		DrawCicleShapeButton.setText(resourceMap.getString("DrawRectangleButton.text")); // NOI18N
		DrawCicleShapeButton.setFocusable(false);
		DrawCicleShapeButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
		DrawCicleShapeButton.setName("DrawCicleShapeButton"); // NOI18N
		DrawCicleShapeButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
		toolBar.add(DrawCicleShapeButton);
		...
		ExportButton.setAction(actionMap.get("save"));
		ExportButton.setIcon(resourceMap.getIcon("SaveIcon.icon")); // NOI18N
		ExportButton.setText(resourceMap.getString("DragToggleButton.text")); // NOI18N
	...
	private JButton DrawCicleShapeButton;
	private JButton NewRectangleShapeButton;
